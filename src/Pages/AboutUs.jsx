function AboutUs() {
  ...
  return (
    <div className="aboutUsBody">
        ...
        <br></br>
        <p>My name is Derek and I am Fancy Dutch. I was raised outside of Pennsylvania but I was raised knowing my heritage. It's unknown when my family lost the language. My Dutch grandmother who was from Pennsylvania died when I was young, so I can't ask her anymore and I know my mother never knew the language.</p>
        <br></br>
